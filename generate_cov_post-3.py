...
logging.basicConfig(filename='logs/covariance_{}_{}_{}_{}_post.log'.format(tracer, region, zmin, zmax), level=logging.DEBUG)

# Load configuration from YAML file
try:
    with open("config_covariance_post.yaml", "r") as config_file:
        config = yaml.safe_load(config_file)
        logger.info('Successfully loaded configuration from config_covariance_post.yaml')
